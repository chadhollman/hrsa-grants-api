...
CREATE TABLE "wic_totals" (
    ...
    "4-1-23" REAL  NOT NULL ,
    "5-1-23" REAL  NOT NULL ,
    "6-1-23" REAL  NOT NULL ,
    "7-1-23" REAL  NOT NULL ,
    "8-1-23" REAL  NOT NULL ,
    "9-1-23" REAL  NOT NULL ,
    "10-1-22" REAL  NOT NULL ,
    "11-1-22" REAL  NOT NULL ,
    "12-1-22" REAL  NOT NULL ,
